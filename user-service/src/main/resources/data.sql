...
VALUES
  ('alice','alice@example.com', '$2a$12$FsEQT3Zw0PeNv7iW5jmsF.6BZ70WKzIkdpqThESAnE.G2FhgvVoy6', TRUE, 'STUDENT'),
  ('Bob','bob@example.com',   '$2a$12$hgpOZw7bTi1Ky796XgJDMOsjh4oWeSRkaHVn71EgeO1xc4rA/TeGG',   TRUE, 'STUDENT'),
  ('Nhat An','nhatan@example.com', '$2a$12$s0oTQbQkFQvW96GtQBsFbunQ7SkfqYikaw9LuLZp3Sq1QhYniVnJu',  TRUE, 'STUDENT'),
...
VALUES
  (1,'Alice Nguyen', FALSE, '2005-03-15', '0123456789', '123 Đường A, Quận 1, TP.HCM', 'https://example.com/avatar/alice.jpg'),
  (2,'Bob Tran', TRUE,  '1985-10-20', '0987654321', '456 Đường B, Quận 3, TP.HCM', NULL),
  (3,'Nguyen Hoang Nhat An', TRUE, '2004-08-20', '0901922117', '789 Đường C, Quận 5, TP.HCM', 'https://example.com/avatar/nhatan.jpg');
